  ...
  return (
    <Dialog open={open} onClose={onClose} fullScreen={isMobile}>
      ...
      <DialogContent dividers>
        <DialogContentText>
          This is a little implementation of{' '}
          <Link
          ...
          , a cellular automaton meant to show how complex and unexpected
          behaviour can arise from simple rules.
          <br />
          Made with
          <svg
            aria-label="React"
